...
5. The builder outputs a lot of errors and warnings, that we need to look into. See [log file](https://github.com/biodiversitydata-se/taxon-build-test/blob/master/lucene/runs/201013-122115-gtdb-gbif-bb/run.log) (for Archaea test only, though).
